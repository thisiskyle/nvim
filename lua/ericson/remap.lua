...
vim.keymap.set('n', '<leader>fc', tscope.diagnostics, { desc = "Find command" })
vim.keymap.set('n', '<leader>fch', tscope.diagnostics, { desc = "Find command history" })
...
vim.keymap.set('n', '<leader>frg', tscope.registers, { desc = "Find registers" })
